            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
	                        <%--
	                        <c:forEach var="i" begin="0" end="${fn:length(catList)-1}" step="1">
	                            <li><a href="#">${fn:length(catList)}</a></li>
	                        </c:forEach>
	                        --%>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/hero/hhh.jpg">
                        <div class="hero__text">
                            <span>Freelancer Market</span>
                            <h2>202만건의 거래 <br/>98.6%의 만족도</h2>
                            <p style="font-weight:bold">전문가로 등록하고 싶으신가요?</p>
                            <c:if test="${loginInfo==null }">
                            	<a href="register.mb" class="primary-btn">회원가입 후 등록하기</a>
                            </c:if>
                            <c:if test="${loginInfo!=null }">
                            	<a href="category.fm" class="primary-btn">전문가로 상품 등록하기</a>
                            </c:if>
                        </div>
                    </div>
                </div>
            ...
            <c:forEach items="${catList }" var="list">
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<%=request.getContextPath() %>/resources/${list.mimgname}">
                            <!-- 바로가기 아이콘 -->
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="detail.fm?num=${list.num }&pageNumber=${pageInfo.pageNumber}"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
