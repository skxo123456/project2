    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/new/css/style.css" type="text/css">
		...
		<script>
			function goGeneric(conpath) {
				location.href = conpath + "/register.mb";
			}
			function goElements(conpath) {
				location.href = conpath + "/elements";
			}
			function goLogin(conpath) {
				location.href = conpath + "/login.mb";
			}
			function logout(conpath) {
				location.href = conpath + "/logout.jsp";
			}
			function change(conpath) {
				
				location.href = conpath + "/change.mb"
			}
			function CATEGORY(conpath) {
				var flag = true;
				location.href = conpath + "/category.fm?flag="+flag;
			}
		</script>
		
		<c:if test="${loginInfo == null }">
		<input type="button" value="회원가입" onClick="goGeneric('<%=conpath%>')"/>
		<input type="button" value="로그인" onClick="goLogin('<%=conpath%>')"/>
		</c:if>
		
	</head>
<c:if test="${loginInfo.type == 0 }">
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                <a href="<%=conpath %>/logout.jsp"><i class="fa fa-user"></i> Logout</a>
            </div>
        </div>
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class="active"><a href="result.fm">Home</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="header__top__left">
                            <ul>
                                ...
                                <li>${loginInfo.nickname }님 반갑습니다.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <input type="button"  class="site-btn" value="사용자 전환" onClick="change('<%=conpath%>')"/>
                        <br>
                            <h4>마이 크몽</h4>
                            <ul>
                                <li><a href="#">나의 견적 요청</a></li>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="${pageContext.request.contextPath}/resources/new/img/latest-product/lp-1.jpg" alt="">
                                            </div>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="${pageContext.request.contextPath}/resources/new/img/latest-product/lp-2.jpg" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Crab Pool Security</h6>
                                                <span>$30.00</span>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="${pageContext.request.contextPath}/resources/new/img/latest-product/lp-3.jpg" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Crab Pool Security</h6>
                                                <span>$30.00</span>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-2.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-3.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-4.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-5.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-6.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-7.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-8.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-9.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-10.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-11.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/new/img/product/product-12.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
							<div class="sidebar__item">
								<input type="button" class="site-btn" value="사용자 전환"
									onClick="change('<%=conpath%>')" /> <br>
								<h4>마이 크몽</h4>
								<ul>
									<li><a href="#">보낸 견적</a></li>
									<li><a href="#">판매 관리</a></li>
									<!-- <li><a href="myService.mb">나의 서비스</a></li> -->
									<li>
										<div class="dropdown">
											<button class="dropbtn">나의 서비스</button>
                ...
                <div class="col-lg-9 col-md-7">
                   ...
                   <c:forEach var="lists" items="${lists }">
                   		<table border="1" align ="center" style="width: 70%; height:50px">
                   			<tr>
                   				<td> <img src=" <%=request.getContextPath()+"/resources/"%>${lists.simgname }" width="100px" height="100px"></td>
                   				<td width="400px">${lists.num }<hr>asd</td>
                   			</tr>
                   		</table>
                   		<br>
                   </c:forEach>
                   <div align="center"><input type="button"  value="의뢰 추가하기" onClick="CATEGORY('<%=conpath%>')"/></div>
                   <!-- <div style="border-style: 2px dotted; border-color: gray;"><a href="category.fm">서비스 등록하기</a></div> -->
                </div>
            </div>
        </div>
    </section>
